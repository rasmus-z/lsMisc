...
TEST_F(FileOperationTest, MoveFile) {
	...
	EXPECT_TRUE(SHCopyFile(p3, p1) == 0);
	EXPECT_TRUE(SHCopyFile(p4, p1) == 0);
	...
	ws.push_back(p3);
	ws.push_back(p4);
	EXPECT_TRUE(SHMoveFile(dir, ws) == 0);
	...
	ws.push_back(p3);
	ws.push_back(p4);
	EXPECT_TRUE(SHCopyFile(dir, ws) == 0);
	...
	wsD.push_back(p5);
	wsD.push_back(p6);
	EXPECT_TRUE(SHMoveFile(wsD, wsS) == 0);
	...
	wsD.push_back(p3);
	wsD.push_back(p4);
	EXPECT_TRUE(SHCopyFile(wsD, wsS) == 0);
}
